...
The current version of the Confluent Platform is 5.3.2. How to manually download and install the platfor mis decsribed at https://docs.confluent.io/5.3.2/installation/installing_cp/zip-tar.html.

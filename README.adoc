...
Please create your custom team projects at link:projects/[], so that we can share our code. In order to distinguish them, pleas prefix the name of your projects with your team name.
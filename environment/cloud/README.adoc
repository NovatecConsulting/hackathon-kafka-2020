...
For more information about Confluent Cloud CLI installation, see https://docs.confluent.io/{cp-version}/cloud/cli/install.html.

=== Confluent Cloud Login and First Steps

For detailed information see https://docs.confluent.io/{cp-version}/cloud/cli/install.html#next-steps.
